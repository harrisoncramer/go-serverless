// The routing functions that handle different requests
package handlers
...
import (
	...
	"github.com/harrisoncramer/go-serverless/pkg/user"
)

const ErrorMethodNotAllowed = "Error, method not allowed"
